...
namespace WhojooSite.View.Clients.Api.RecipesModule
{
    ...
    public partial class RecipesModuleRequestBuilder : BaseRequestBuilder
    {
        ...
        public RecipesModuleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/recipes-module", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::WhojooSite.View.Clients.Api.RecipesModule.RecipesModuleRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecipesModuleRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/recipes-module", rawUrl)
        {
        }
    }
}
