...
namespace WhojooSite.View.Clients.Api.RecipesModule.Recipes.StartNewRecipe
{
    ...
    public partial class StartNewRecipeRequestBuilder : BaseRequestBuilder
    {
        ...
        public StartNewRecipeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/recipes-module/recipes/start-new-recipe", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::WhojooSite.View.Clients.Api.RecipesModule.Recipes.StartNewRecipe.StartNewRecipeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StartNewRecipeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/recipes-module/recipes/start-new-recipe", rawUrl)
        {
        }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class StartNewRecipeRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
